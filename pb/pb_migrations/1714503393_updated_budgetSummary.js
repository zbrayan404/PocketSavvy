...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("j9jjvmfn")

  // remove
  collection.schema.removeField("ri22lvgk")

  // remove
  collection.schema.removeField("v1ua3dis")

  // remove
  collection.schema.removeField("sp7xwxmw")

  // remove
  collection.schema.removeField("uqydutyo")

  // remove
  collection.schema.removeField("9fzwn4ms")

  // remove
  collection.schema.removeField("0i7dqsqu")

  // remove
  collection.schema.removeField("vg8fhukw")

  // remove
  collection.schema.removeField("25w6ysuu")

  // remove
  collection.schema.removeField("5qv9gafo")

  // remove
  collection.schema.removeField("aijomebg")
