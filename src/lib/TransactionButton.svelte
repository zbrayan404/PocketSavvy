...
<div>
    <button class="edit-button" on:click={() => isMenuVisible = !isMenuVisible} bind:this={editButton}><MoreHorizontal /></button>
    {#if isMenuVisible}
    <div class='menu'>
        ...
        <div class="body-page">
            ...
            {#if isDeleteMenuVisible}
                <form  method="POST" action="?/deleteTransaction">
                    ...
                    <div class="buttons">
                        <button type="button" on:click={() => isDeleteMenuVisible = false}>Cancel</button>
