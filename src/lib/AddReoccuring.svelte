<script>
    ...
    import ReoccuringForm from "$lib/ReoccuringForm.svelte";
    
    export let isOpen = false;
    export let onClose;
    export let categoryOptions = [];
    
    let activeTab = 'Reoccuring';

    function switchToReoccuring() {
...
<div class="form-page">
    <div class="body-page">
        <div>
            <div class="nav flex">
                <button on:click={switchToReoccuring} class:selected={activeTab === 'Reoccuring'} >Reoccuring</button>
            ...
            <section class="card">
                ...
                {#if activeTab === 'Reoccuring'}
                <ReoccuringForm {categoryOptions} {onClose}></ReoccuringForm>
                {:else}
